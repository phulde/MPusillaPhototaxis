...
%       TOTAL PLOT:
%  ###nm_300muEplot  .fig and .png  <->  plot showing the behaviour of all
%  the data sites
%
...
clc
tic
strName = '02-12-15_625nm_300muE';
strDS = {'_DS1','_DS2','_DS3','_DS4','_DS5','_DS6','_DS7','_DS8','_DS9',...
    'DS10','_DS11','_DS12','_DS13','_DS14','_DS15'};
% strName = {'02-12-15_625nm_300muE_DS1','02-12-15_625nm_300muE_DS2', ...
%     '02-12-15_625nm_300muE_DS3',...
%     '02-12-15_625nm_300muE_DS4','02-12-15_625nm_300muE_DS5','02-12-15_625nm_300muE_DS6',...
%     '02-12-15_625nm_300muE_DS7', '02-12-15_625nm_300muE_DS8','02-12-15_625nm_300muE_DS9',...
%     '02-12-15_625nm_300muE_DS10','02-12-15_625nm_300muE_DS11','02-12-15_625nm_300muE_DS12',...
%     '02-12-15_625nm_300muE_DS13','02-12-15_625nm_300muE_DS14','02-12-15_625nm_300muE_DS15'};
% strOut = {'625nm 300\muEm^{-2}s^{-1}','625nm_300muEplot.fig',...
%     '625nm_300muEplot.png','625nm_300muECulmData.mat',...
%     '625nm 300\muEm^{-2}s^{-1} Culm Plot','625nm_300muECulmPlot.fig',...
%     '625nm_300muECulmPlot.png'};
strOut = {'625nm 300\muEm^{-2}s^{-1}','625nm_300muEplot.fig',...
    '625nm_300muEplot.png','625nm_300muECulmData.mat',...
    '625nm 300\muEm^{-2}s^{-1} Culm Plot','625nm_300muECulmPlot.fig',...
    '625nm_300muECulmPlot.png'};
...
pkvalue = [1 7 7 7 7 6 6 6 6 5 4 3 4 5 5; 11 11 11 11 11 11 11 11 11 11 11 11 11 11 11];
Scans = 15;
NumImages = 10;
ScanPeriod = 230; % Time taken to return to site in seconds
STARTINGDS = 10; ENDINGDS = 11;
%% Image Folder:
% Access storage folder, OR work through with explicit directories?

% storagefolder = 'C:\Users\Richard\Documents\PhD\02-12-15\625nm\300E\021215_1646\';
...
%         'location','northeastoutside');
    if DSNum == ENDINGDS
    leg = legend([DSPlot(1,STARTINGDS:ENDINGDS)],...
        'Data Site 2', 'Data Site 3', 'Data Site 4',...
        'Data Site 5', 'Data Site 6', 'Data Site 7',...
        'Data Site 8', 'Data Site 9', 'Data Site 10', 'Data Site 11',...
        'Data Site 12','location','northeastoutside');
