...
%	07/2016 RHenshaw added variable to allow iterative running of program, such that if excessive combinatorics are encountered, reduce maxdisp and try again
%
            ...
            for nc =1:nclust
                ...
                if nnew > 5
                    ...
                    for ii =1:nnew
                        ...
                        if rnsteps > 2.e+5
                            disp(['Excessive Combinitorics, re-evaluate param'])
							reduce_maxdisp = 1;
                            return maxdisp
                        end
                    end
...
if goodenough > 0 
    ...
    if nkeep == 0
        ...
        disp('the code broke at line 1048')
        return
    end
    if nkeep < n
        bigresx = bigresx(:,wkeep);
